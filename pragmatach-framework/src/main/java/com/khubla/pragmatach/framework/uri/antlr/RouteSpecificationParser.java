...
public class RouteSpecificationParser extends Parser {
		...
		try {
			...
			while (true) {
				...
				case 1 :
					...
					{
					char_literal1=(Token)match(input,5,FOLLOW_5_in_routespecification74); if (state.failed) return retval;
	...
	public final RouteSpecificationParser.idsegment_return idsegment() throws RecognitionException {
		...
		try {
			...
			char_literal5=(Token)match(input,6,FOLLOW_6_in_idsegment101); if (state.failed) return retval;
			if ( state.backtracking==0 ) {
	...
	public final RouteSpecificationParser.pathsegment_return pathsegment() throws RecognitionException {
		...
		try {
			...
			ALPHANUM7=(Token)match(input,ALPHANUM,FOLLOW_ALPHANUM_in_pathsegment113); if (state.failed) return retval;
			if ( state.backtracking==0 ) {
	...
	public final RouteSpecificationParser.id_return id() throws RecognitionException {
		...
		try {
			...
			ALPHANUM8=(Token)match(input,ALPHANUM,FOLLOW_ALPHANUM_in_id123); if (state.failed) return retval;
			if ( state.backtracking==0 ) {
