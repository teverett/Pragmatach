...
public class AES {
	...
	public static String decrypt(String encryptedPayload, String key) throws Exception {
		try {
			...
			final CipherInputStream CipherInputStream = new CipherInputStream(new ByteArrayInputStream(Base64.decodeBase64(encryptedPayload.getBytes("UTF-8"))), cipher);
	...
	public static String encrypt(String payload, String key) throws Exception {
		try {
			...
			final CipherInputStream CipherInputStream = new CipherInputStream(new ByteArrayInputStream(payload.getBytes("UTF-8")), cipher);
			final ByteArrayOutputStream baos = new ByteArrayOutputStream();
			IOUtils.copy(CipherInputStream, baos);
